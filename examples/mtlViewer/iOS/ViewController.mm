...
-(void)_applyOptions {
    ...
    _osdRenderer.drawWireframe = _wireframeSwitch.isOn;
    _osdRenderer.drawBezierEdges = _controlMeshSwitch.isOn;
    _osdRenderer.drawControlEdges = _controlMeshSwitch.isOn;
    _osdRenderer.usePatchClipCulling = _patchClipCullingSwitch.isOn;
    
    _osdRenderer.tessellationMode = kTessellationModeMetal;
...
- (IBAction)switchChanged:(UISwitch *)sender {
    if(sender == _wireframeSwitch) {
        _osdRenderer.drawWireframe = sender.isOn;
        ...
        _osdRenderer.drawControlEdges = sender.isOn;
...
-(NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component {
    if(pickerView == _modelPickerView) {
        ...
        switch((ShadingMode)row) {
            case kShadingModeMaterial: return @"Material";
            case kShadingModeNormals: return @"Normal";
            case kShadingModePatchCoord: return @"Patch Coord";
            case kShadingModePatchType: return @"Patch Type";
        }
    }
    return @"";
}
