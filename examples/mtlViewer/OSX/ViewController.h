...
@property (weak) IBOutlet NSButton *controlCageCheckbox;
...
@property (weak) IBOutlet NSPopUpButton *tessellationModePopup;
@property (weak) IBOutlet NSPopUpButton *shadingModePopup;
...
@property (weak) IBOutlet NSPopUpButton *endcapModePopup;
