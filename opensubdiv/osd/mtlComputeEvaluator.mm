...
#undef DEFINE
    ...
    _computeLibrary =
    [context->device newLibraryWithSource:@(KernelSource)
    ...
    _evalStencils =
        [context->device newComputePipelineStateWithFunction:[_computeLibrary newFunctionWithName:@"eval_stencils"]
                                                     error:&err];
    if (!_evalStencils)
    {
    ...
    _evalPatches =
      [context->device newComputePipelineStateWithFunction:[_computeLibrary newFunctionWithName:@"eval_patches"]
                                                     error:&err];
    if (!_evalPatches)
    {
